...
![Global search results](screenshots/06-search-results.png)
...
![Card and item drag reorder](screenshots/02_Card_and_Item_Drag.gif)
...
![Sidebar dividers and group icons](screenshots/07-sidebar-dividers-group-icons.gif)
...
![Item form - URL with favicon fetch](screenshots/03-item-form-url.gif)

![Item form - Command templates](screenshots/04-item-form-command-templates.gif)
...
![Group Manager - inline filter](screenshots/10-group-manager-filter.png)

![Group Manager - bulk select and actions](screenshots/09-group-manager-bulk.gif)
...
![Settings - appearance](screenshots/11-settings-appearance.gif)
